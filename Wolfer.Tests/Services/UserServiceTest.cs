...
//         
//         _userRepositoryMock.Verify(repository => repository.UpdateUser(It.Is<IdentityUser>(user => user.Email == expectedUser.Email && user.UserName == expectedUser.UserName), userInfoUpdateDto.OldPassword, userInfoUpdateDto.NewPassword), Times.Once);
//     }
//     
